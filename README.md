...
Once the `conda-forge` channel has been enabled, `r-rcompanion` can be installed with:

```
conda install r-rcompanion
```

It is possible to list all of the versions of `r-rcompanion` available on your platform with:
