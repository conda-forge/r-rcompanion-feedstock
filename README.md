...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/r-rcompanion-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-rcompanion-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add r-rcompanion
# for installing globally
pixi global install r-rcompanion
```
...
It is possible to list all of the versions of `r-rcompanion` available on your platform:
...
```
pixi search r-rcompanion --channel conda-forge
```
